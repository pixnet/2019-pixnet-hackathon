...
<p>決賽評選標準：</p>
<p>決賽作品需切合賽事主題精神，並至少包含一項主辦單位所提供之痞客邦或 HotelsCombined 數據資料、API，評審將依據各獎項評比重點評選出優勝作品。</p>

獎項   |評審大獎                     |社群應用獎               |創意∞獎           |極客獎
:----:|:--------------------------:|:---------------------:|:---------------:|:----------------------:
獎金   | 新台幣十萬元                 |新台幣五萬元             |新台幣三萬元       |新台幣三萬元
評選標準| 綜合評比技術力、創新性、完成度。|評比作品利用社群平台（例如：痞客邦、Facebook、IG等）發揮效益之應用。|評比資料、技術、作品使用情境等創意性。|評比演算能力、技術成熟度、作品穩定性與效能。
